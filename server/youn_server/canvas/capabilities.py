...
CAPABILITIES: dict = {
    ...
    "tw_tokens": {
        ...
        "text": ["text-[Npx]", "text-center", "text-right",
                 "font-thin", "font-light", "font-medium", "font-semibold",
                 "font-bold", "font-black", "font-normal",
    ...
    "style_keys": ["backgroundColor", "color", "borderRadius", "padding",
                   ...
                   "overflow", "fontSize", "fontWeight", "textAlign", "writingMode",
    ...
    "not_supported": [
        ...
        "多字体族（fontFamily 被忽略）",
        "writing-mode 竖排：西文字符直立堆叠（不做 90° 旋转）/ 竖排专用标点形",
