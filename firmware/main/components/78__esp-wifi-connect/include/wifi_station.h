...
#include "network_probe_target.h"
...
public:
    ...
    void Start();
    void Stop();
    void SuspendForExternalAp();
    void ResumeAfterExternalAp();
    bool IsConnected();
...
private:
    ...
    esp_timer_handle_t fast_timer_handle_ = nullptr;
    bool fast_attempt_ = false;
    int fast_fail_count_ = 0;
    bool force_scan_ = false;
    TaskHandle_t ip_fast_task_handle_ = nullptr;
    bool ip_fast_attempt_ = false;
    bool ip_fast_ready_ = false;
    ...
    static void FastConnectTimeout(void* arg);
