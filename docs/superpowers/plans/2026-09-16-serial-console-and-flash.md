...
`frontend/src/md5.js`：一次性实现 `md5Hex(bytes: Uint8Array): string`（标准 RFC 1321 逐块实现，约 60 行）。**要求**：对 `new TextEncoder().encode('abc')` 必须返回 `900150983cd24fb0d6963f7d28e17f72` —— 用下面的脚本证明。
